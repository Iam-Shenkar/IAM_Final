...
const getFeatures = async (accountId) => {
  ...
  if (currentFeatures) {
    result = {
      status: 200,
      message: `OK, available features are: ${currentFeatures}`,
...
const getSeats = async (accountId) => {
  ...
  if (remainSeats < 0) {
    ...
    result = {
      status: 200,
      message: `OK, available seats: ${remainSeats}`,
      data: { seats: remainSeats },
    };
  }
  return result;
};
...
const getCredit = async (accountId) => {
  ...
  if (currentCredit <= 0) {
    ...
    result = {
      status: 200,
      message: `OK, available credit: ${currentCredit}`,
      data: { credit: currentCredit },
    };
  }
  return result;
};
...
const setSeats = async (accountId, count = 1) => {
  ...
  if (currentSeat >= count) {
    ...
    result = {
      status: 200,
      message: `OK, used seats has been updated: ${newSeats}`,
      data: { seats: remain },
    };
  } else {
    result = {
      status: 400,
      message: 'ERROR, no available seats',
      data: { seats: -1 },
    };
  }
  return result;
...
const setCredit = async (accountId, count = 1) => {
  ...
  if (currentCredit >= count) {
    ...
    result = {
      status: 200,
      message: `OK, used seats has been updated: ${newCredit}`,
      data: { credit: newCredit },
    };
  } else {
    result = {
      status: 400,
      message: 'ERROR, no available credit',
      data: { credit: -1 },
    };
  }
  return result;
...
const setFeature = async (accountId, feature) => {
  ...
  if (isFeatureExists) {
    ...
    result = {
      status: 200,
      message: `OK, feature ${feature} has been added`,
      data: { feature },
    };
  }
  return result;
